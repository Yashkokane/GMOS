  ...
  <>
    <div className='card'>
      <div className='row'>
        ...
        <div className='row' style={{marginLeft: '100px', marginTop: '10px', marginRight: '100px'}}>
                  ...
                  <td>
                    <td>
                      <a
                        ...
                        data-kt-menu-placement='bottom-end'
                        data-kt-menu-flip='top-end'
                        style={{backgroundColor: '#5d2d91', color: 'white', marginRight: '20px'}}
                      >
                        Actions
                        <span className='svg-icon svg-icon-5 m-0'>
                          <svg
...
const ManageCategory = () => {
  ...
  return (
    <>
      <PageTitle breadcrumbs={[]}>{intl.formatMessage({id: 'Manage Category'})}</PageTitle>
      <ManageCategoryPage />
    </>
  )
}
